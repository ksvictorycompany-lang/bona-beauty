  ...
  return (
    ...
    >
      <div
        ...
        tabIndex={0}
        onKeyDown={onKeyDown}
        aria-label="Service cards — use arrow keys to navigate"
      >
        {/* Atmospheric shadows */}
        <div
          className="pointer-events-none absolute inset-x-0 top-6 mx-auto h-48 w-[70%] rounded-full blur-3xl"
          style={{ background: "rgba(201,160,64,0.07)" }}
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 mx-auto h-32 w-[76%] rounded-full blur-3xl"
          style={{ background: "rgba(196,102,90,0.07)" }}
          aria-hidden="true"
        />
            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  key={item.id}
                  className={cn(
                    "absolute bottom-0 overflow-hidden will-change-transform select-none rounded-2xl",
            ...
            return (
              <button
                ...
                style={{
                  width: on ? "24px" : "6px",
                  height: "6px",
                  background: on ? "#C9A040" : "rgba(201,160,64,0.3)",
                }}
